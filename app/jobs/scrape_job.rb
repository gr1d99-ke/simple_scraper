...
class ScrapeJob < ApplicationJob
  ...
  #    ScraperService.call(options['uri_id'], depth)
  #    scraped_uri = save_scrape(uri, depth) do |scraped_uri|
  ...
  #        end
  #
  #        ExtractUrlService.call(document, depth, uri.id)
  #      end
  #    end
  #
  #    scraped_uri.update(
  ...
  #      redis.del("scraped_links:#{depth}:#{uri.id}")
  #    end
  #
